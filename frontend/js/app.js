...
import DrugAssistantPage from '../pages/drug-assistant.js';
...
class App {
  ...
  registerRoutes() {
    ...
    router.register('/drug-assistant', DrugAssistantPage, { auth: true, showNavbar: true });
    router.register('/admin', AdminPage, { auth: true, admin: true, showNavbar: false });
  }
